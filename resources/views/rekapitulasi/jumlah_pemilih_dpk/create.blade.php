...
@section('title', 'Tambah Jumlah Pemilih DPK')

@section('content')
<section class="section">
    <div class="section-header">
        <h1>Tambah Jumlah Pemilih DPK</h1>
    </div>

    <div class="section-body">
        <h2 class="section-title">Formulir Tambah Jumlah Pemilih DPK</h2>
        <p class="section-lead">
            Halaman ini memungkinkan Anda untuk menambahkan data jumlah pemilih DPK baru.
        </p>

        <div class="card">
            <div class="card-header">
                <h4>Formulir Jumlah Pemilih DPK</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('jumlah_pemilih_dpk.store') }}" method="POST">
                    @csrf
