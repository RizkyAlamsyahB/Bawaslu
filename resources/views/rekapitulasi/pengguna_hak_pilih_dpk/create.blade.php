...
@section('title', 'Tambah Pengguna Hak Pilih DPK')

@section('content')
<section class="section">
    <div class="section-header">
        <h1>Tambah Pengguna Hak Pilih DPK</h1>
    </div>

    <div class="section-body">
        <h2 class="section-title">Formulir Tambah Pengguna Hak Pilih DPK</h2>
        <p class="section-lead">
            Halaman ini memungkinkan Anda untuk menambahkan data pengguna hak pilih DPK baru.
        </p>

        <div class="card">
            <div class="card-header">
                <h4>Formulir Pengguna Hak Pilih DPK</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('pengguna_hak_pilih_dpk.store') }}" method="POST">
                    @csrf
