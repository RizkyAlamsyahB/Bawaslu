                ...
                <div class="card-body">
                    <form action="{{ route('kelurahan.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama_kelurahan" name="nama_kelurahan" value="{{ old('nama_kelurahan') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="kode_kelurahan" name="kode_kelurahan" value="{{ old('kode_kelurahan') }}" required>
